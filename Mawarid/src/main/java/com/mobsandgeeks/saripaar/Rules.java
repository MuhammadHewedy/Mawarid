 ...
 * and indirect subclasses that includes but not limited to {@link android.widget.EditText},
 * {@link android.widget.AutoCompleteTextView}, {@link android.inputmethodservice.ExtractEditText} and {@link android.widget.MultiAutoCompleteTextView}.
 * {@link android.widget.Checkable} references notable implementing classes but not limited to {@link android.widget.CheckBox},
 * {@link android.widget.CheckedTextView}, {@link android.widget.RadioButton} and {@link android.widget.ToggleButton}.
 *
 * You may use it with any custom {@link android.view.View}s you may define that extends or implements the above
...
public final class Rules {
    ...
    /**
     * The classical required {@link com.mobsandgeeks.saripaar.Rule}. Checks if the {@link android.widget.TextView} or its subclass
     * {@link android.view.View}'s displayed text is not empty.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param trimInput Specifies whether to trim the text returned by {@code getText()}.
     *
     * @return True if the {@link android.view.View} is not empty, false otherwise. The return value is affected
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text matches the
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text has at least the
     * minimum number of characters specified by this {@link com.mobsandgeeks.saripaar.Rule}.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text's length is less
     * than or equal to the maximum number of characters specified by this {@link com.mobsandgeeks.saripaar.Rule}.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
    ...
    /**
     * Checks if the contents of two {@link android.widget.TextView}s are equal. Ideal for password and confirm
     * password.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param anotherTextView The {@link android.widget.TextView} whose contents have to be checked against the
     *          {@link android.widget.TextView} that is being validated.
     *
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text value equals
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text value is
    ...
    /**
     * Checks if the {@link android.widget.TextView} or its subclass {@link android.view.View}'s displayed text value is less
    ...
    /**
     * Checks if the {@link android.widget.Checkable} or its subclass {@link android.view.View}'s state is same as the state
     * specified.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
    ...
    /**
     * Checks if the {@link android.widget.Spinner}'s selected item's {@link String} value (obtained by calling
     * {@code toString()} on the selected item) equals the expected {@link String} value.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param expectedString {@link String} value to be compared with the text returned by
     *          calling {@code toString()} on the selected {@link android.widget.Spinner} item.
     * @param ignoreCase Specifies whether the text's case differences should be ignored.
    ...
    /**
     * Checks if the {@link android.widget.Spinner}'s selected item's position (obtained by calling
     ...
     *          calling {@code getSelectedItemPosition()} on the {@link android.widget.Spinner}.
     *
     * @return True if both the {@link String} values are equal.
     */
    ...
    /**
     * Performs an '&&' (and) operation on the given array of {@link com.mobsandgeeks.saripaar.Rules}.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param rules An array of {@link com.mobsandgeeks.saripaar.Rule}s on which the '&&' (and) operation is to be performed.
     *
     * @return True if all {@link com.mobsandgeeks.saripaar.Rule}s are valid.
     */
    ...
    /**
     * Performs a '||' (or) operation on the given array of {@link com.mobsandgeeks.saripaar.Rules}.
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param rules An array of {@link com.mobsandgeeks.saripaar.Rule}s on which the '||' (or) operation is to be performed.
     *
     * @return True if at least one of the {@link com.mobsandgeeks.saripaar.Rule}s is valid.
     */
     ...
     *
     * @param failureMessage The failure message for this {@link com.mobsandgeeks.saripaar.Rule}.
     * @param viewsAndRules A {@link java.util.LinkedHashMap} containing rules for different {@link android.view.View}s.
     *
     * @return True if all {@link com.mobsandgeeks.saripaar.Rule}s are valid.
     */
